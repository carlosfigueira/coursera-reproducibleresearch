...
From the numbers and plots above, we can see that the tornado / hail events are the ones that have caused the larges number of injuries / fatalities. However, on a per-case basis, dense fog and extreme heat events have a larger impact on the population health, with 

## Documents:

- Summary of events (with grouping): http://www.ncdc.noaa.gov/oa/climate/sd/annsum2009.pdf
- Description: http://www.ncdc.noaa.gov/stormevents/pd01016005curr.pdf
